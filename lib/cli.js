...
function res_flattern(resource, dependencies) {
    var arr = ResFlatternUtils.flattern(resource);
    if (dependencies) {
        var _loop_1 = function (i) {
            var a = arr[i];
            var deps = dependencies.filter(function (x) { return x.resource.test(a.url); });
            if (deps.length === 0) {
            ...
            var _loop_2 = function (j) {
                ...
                var isSame = deps.some(function (x) { return x.resource.test(b.url); });
                if (isSame) {
                    indexes.push(j);
                    return "continue";
                }
                var isDependency = deps.some(function (x) { return x.dependency.test(b.url); });
                if (isDependency) {
                    var cursor_1 = j;
                    indexes.forEach(function (idx) {
                        arr.splice(++cursor_1, 0, arr[idx]);
                    });
            ...
            for (var j = i + 1; j < arr.length; j++) {
                ...
                switch (state_2) {
                    case "continue-outer": return state_2;
                }
            }
            out_i_1 = i;
        };
...
var Middlewares = /** @class */ (function () {
    ...
    Middlewares.prototype.run = function (name) {
        ...
        function next() {
            ...
            args = nextArgs;
            var fn = arr.shift();
            var result = fn.call.apply(fn, tslib_1.__spreadArrays([null], args));
            if (result != null) {
                if (result.then) {
...
var Resource = /** @class */ (function () {
    function Resource(includeData, parent, solution) {
        ...
        if (includeData.page) {
            ...
            if (owner != null) {
                this.inPages = tslib_1.__spreadArrays(owner.inPages);
            }
        }
        ...
        var mappedUrl = this.solution.mapUrl(url);
        if (mappedUrl != url) {
    ...
    Resource.prototype.toTarget = function (solution, settings) {
        var _a;
        var resource = (settings === null || settings === void 0 ? void 0 : settings.targetType) === 'static'
...
exports.MaskAssets = {
    rewrite: function (resource, targetResource, solution) {
        ...
        while (match = regexp.exec(content)) {
            ...
            if (solution.assetsManager.shouldCopy(href) === false) {
                if (solution.assetsManager.shouldRewritePath(href, resource, targetResource)) {
                    var asset_1 = new Resource_1.Resource({ type: 'asset', url: href }, resource, solution);
                    content = replace(href, match, content, asset_1.url, targetResource.url, solution);
                }
                continue;
            }
            var asset = new Resource_1.Resource({ type: 'asset', url: href }, resource, solution);
            ...
            var assetUrl = asset.toTarget(solution, { targetType: 'static' }).url;
            content = replace(href, match, content, assetUrl, targetResource.url, solution);
        }
        resource.content = content;
        return assets;
...
function replace(href, match, content, assetUrl, targetUrl, solution) {
    var before = content.substring(0, match.index);
    var after = content.substring(match.index + match[0].length);
    var entry = match[0].replace(href, assetUrl);
    return before + entry + after;
}
//# sourceMappingURL=api.js.map
//# sourceMappingURL=MaskAssets.ts.map;
					...
					if (isObject(_src_assets_MaskAssets) && isObject(module.exports)) {
...
var atma_utils_1 = require("atma-utils");
var global_1 = _src_global;
var MaskAssets_1 = _src_assets_MaskAssets;
var path_1 = _src_utils_path;
var AssetsManager = /** @class */ (function () {
    ...
    AssetsManager.prototype.rewriteAssets = function (resource, targetResource, solution) {
        var _a;
        var arr = null;
        var type = resource.type;
        if (type === 'load') {
...
var HttpLoader = /** @class */ (function () {
    ...
    HttpLoader.load = function (url, opts) {
...
var LoadBuilder = /** @class */ (function (_super) {
    ...
    LoadBuilder.prototype.createModule = function (outputItem, otherOutputItems) {
        ...
        var html = outputItem
            ...
            _this.solution.assetsManager.rewriteAssets(resource, outputItem.resource, _this.solution);
...
exports.CommonJsBuilderSimplified = {
    wrapModule: function (resource, outputItem, outputItems, setts) {
        var varId = getVarId(resource);
        var content = resource.content;
        content = replaceWithVarIds(content, resource, this.solution);
        content = Templates_1.Templates
            .ModuleSimplified
            .replace(/___VAR_ID___/g, function () { return varId; })
            .replace(/___MODULE___/g, function () { return content; })
            .replace(/___FOOTER___/g, function () { var _a, _b; return ((_b = (_a = setts === null || setts === void 0 ? void 0 : setts.partials) === null || _a === void 0 ? void 0 : _a.footer) !== null && _b !== void 0 ? _b : ''); });
        ;
...
var BaseScriptBuilder = /** @class */ (function (_super) {
    ...
    BaseScriptBuilder.prototype.wrapModule = function (resource, outputItem, otherOutputItems, opts) {
...
var CommonJsBuilder = /** @class */ (function (_super) {
    ...
    CommonJsBuilder.prototype.wrapModule = function (resource, outputItem, outputItems, setts) {
        var opts = this.solution.iteration;
        if (opts.commonjs == null) {
            opts.commonjs = {
                addHeading: true,
        ...
        var module = Templates_1.Templates
            ...
            .replace('%FOOTER%', function () { var _a, _b; return ((_b = (_a = setts === null || setts === void 0 ? void 0 : setts.partials) === null || _a === void 0 ? void 0 : _a.footer) !== null && _b !== void 0 ? _b : ''); });
        return body + module;
    };
...
//# sourceMappingURL=AmdJsHandler.ts.map;
				...
				(function () {
					...
					"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var ResourcePropMapping = /** @class */ (function () {
    function ResourcePropMapping(resA, resB) {
        this.resA = resA;
        this.resB = resB;
    }
    ResourcePropMapping.prototype.map = function (resource) {
        var match = true;
...
//# sourceMappingURL=ResourcePropMapping.ts.map;
					...
					if (isObject(_src_class_ResourcePropMapping) && isObject(module.exports)) {
...
var AstUtil_1 = _src_handlers_script_utils_AstUtil;
var Include_1 = _src_class_Include;
var ResourcePropMapping_1 = _src_class_ResourcePropMapping;
var BaseParser_1 = _src_handlers_base_BaseParser;
var atma_utils_1 = require("atma-utils");
...
var IncludeJsBuilder = /** @class */ (function (_super) {
    ...
    IncludeJsBuilder.prototype._createHeading = function (builderOpts, resource, outputItem, otherOutputItems) {
        var _this = this;
        var outputItems = tslib_1.__spreadArrays([outputItem], otherOutputItems);
...
var ModuleFile = /** @class */ (function () {
    ...
    ModuleFile.prototype.toScript = function (parents, options, indent) {
        ...
        var outerContent = this
            .outer
            .arr
            .map(function (x) { return x.toScript(tslib_1.__spreadArrays(parents, [_this]), options); })
    ...
    Exports: {
        ...
        scoped: {
            ...
            map: function (match) {
                ...
                return tslib_1.__spreadArrays([$export], other);
            }
        },
        function: {
...
function removeNestedScopedModules(module, parent, parents, handled) {
    ...
    module.scoped.forEach(function (x) { return removeNestedScopedModules(x, module, tslib_1.__spreadArrays(parents, [{ child: x, module: module }]), handled); });
}
function moveToCommonParent(module, parent, parents, handled) {
    ...
    module.scoped.forEach(function (x, i) { return moveToCommonParent(x, module, tslib_1.__spreadArrays(parents, [{ child: x, module: module }]), handled); });
}
function distinctOuter(module, index, parents, handled) {
    ...
    handled.add(module);
    module.outer.forEach(function (x, i) { return distinctOuter(x, i, tslib_1.__spreadArrays(parents, [{ index: index, module: module }]), handled); });
...
function markLazyImports(module, options, parentIds, handled) {
    ...
    handled.add(module);
    var hash = tslib_1.__assign(tslib_1.__assign({}, parentIds), (_a = {}, _a[module.id] = 1, _a));
...
var MaskJsBuilder = /** @class */ (function (_super) {
    ...
    MaskJsBuilder.prototype.wrapModule = function (resource) {
        var builder = new CommonJsBuilder_1.CommonJsBuilder(this.solution, this.handler);
        var footer = Templates
            .footer
            .replace('%URL%', function () { return resource.url; });
        var content = builder.wrapModule(resource, null, null, {
            partials: {
                footer: footer
            }
        });
...
var CssBuilder = /** @class */ (function (_super) {
    ...
    CssBuilder.prototype.createModule = function (outputItem) {
        ...
        var out = outputItem
            .resources
            .map(function (res) {
            _this.solution.assetsManager.rewriteAssets(res, outputItem.resource, _this.solution);
            return res.content;
        });
        outputItem.resource.content = out.join('\n');
    };
...
var Solution = /** @class */ (function (_super) {
    ...
    Solution.prototype.mapUrl = function (url) {
        var maps = this.opts.rewrites;
        if (maps == null) {
            return url;
        }
        if (url in maps) {
    ...
    getDependencies: function (resource, solution) {
        ...
        function _runMiddlewares(deps) {
            getDependenciesExternal(deps, resource, solution)
                .then(function (deps) { return mapDeps(deps, solution); })
...
(function (ResourceLoader) {
    ...
    var TreeLoader = /** @class */ (function () {
        ...
        TreeLoader.prototype.process = function () {
            ...
            reader(this.resource.filename, this.opts).then(function (content) {
                var end = Date.now();
        ...
        TreeLoader.prototype.processChildren = function () {
            ...
            Parser_1.Parser
                ...
                _this.loadChildren(result).catch(function (err) {
                    _this.promise.reject(err);
                });
            }, function (error) { return _this.promise.reject(error); });
        };
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, alot_1.default(deps).mapAsync(function (dep) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    var loader, res;
                                    return tslib_1.__generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, ResourceLoader.load(dep, this.resource, this.opts, this.solution)];
                                            case 1:
                                                loader = _a.sent();
                                                res = loader.resource;
                                                dep.resource = res;
                        ...
                        case 1:
                            ...
                            resources.forEach(function (res, i) {
                                var dep = deps[i];
                                if (res.isMapped) {
                                    var str = _this.resource.content.replace(dep.url, res.url);
                                    if (str === _this.resource.content) {
                                        throw new Error("Mapped url was not replaced: " + dep.url);
                                    }
                                    _this.resource.content = str;
                                    dep.url = res.url;
                                }
                            });
                            (_a = this.resource.resources).push.apply(_a, resources);
                            this.promise.resolve(this);
                            return [2 /*return*/];
                    }
                });
...
exports.Builder = {
    build: function (resources, solution) {
        ...
        function buildOutputItems() {
            ...
            return alot(items).mapAsync(function (item) {
...
var Bundler = /** @class */ (function (_super) {
    ...
    Bundler.prototype.getResources = function (opts) {
        ...
        return Loader_1.Loader.load(type, path, opts, solution).then(function (resource) {
            return res_1.res_flattern(resource, solution.opts.dependencies).map(function (x) { return x; });
        });
    };
    ...
    Bundler.prototype.build = function (opts) {
        ...
        function build(resource) {
            isBuilding = true;
            var resources = res_1.res_flattern(resource, solution.opts.dependencies);
...
function ensureBundlesConfig(config) {
    if (isMultiConfig(config)) {
        var common_1 = config.common || {};
        var bundles = Object.keys(config.apps)
            .filter(function (name) {
            return config.app == null || config.app.includes(name);
        })
            .map(function (name) {
            var obj = { name: name };
            obj_1.obj_deepExtend(obj, JSON.parse(JSON.stringify(common_1)));
            obj_1.obj_deepExtend(obj, config.apps[name]);
            for (var key in config) {
                ...
                var hostName = key.substring(0, dot);
                ...
                atma_utils_1.obj_setProperty(obj, prop, config[key]);
            }
            return obj;
        });
        return bundles;
...
//# sourceMappingURL=MultiBundle.ts.map;
					...
					if (isObject(_src_config_MultiBundle) && isObject(module.exports)) {
...
var MultiBundle_1 = _src_config_MultiBundle;
function mainBundlerFunction(path, opts) {
    return Bundler_1.Bundler.process(path, opts);
}
var Runner;
(function (Runner) {
    function run(config, bundleFn) {
        if (bundleFn === void 0) { bundleFn = mainBundlerFunction; }
        var bundles = MultiBundle_1.ensureBundlesConfig(config);
        return processMany(bundles, bundleFn);
    }
    Runner.run = run;
    function processMany(bundles, bundleFn) {
        var i = -1, imax = bundles.length, hasWatcher = bundles.some(function (x) { return x.watch; }), results = [];
    ...
    function processSingle(config, bundleFn) {
        validate(config);
        var path = config.file, opts = config;
        ...
        if (opts.configuration) {
            ...
            return Configurator.process(Bundler_1.Bundler).then(function () {
...
//# sourceMappingURL=Runner.ts.map;
					...
					if (isObject(_src_Runner) && isObject(module.exports)) {
...
module.exports = function run() {
    Config
        .load()
        .then(function (config) { return Runner_1.Runner.run(config); });
};
//# sourceMappingURL=cli.js.map
