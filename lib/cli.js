...
exports.CommonJsBuilderSimplified = {
    wrapModule: function (resource, outputItem, outputItems, setts) {
        ...
        content = Templates_1.Templates
            .ModuleSimplified
            .replace(/__VAR_ID__/g, function () { return varId; })
            .replace(/__MODULE__/g, function () { return content; })
            .replace(/__FOOTER__/g, function () { var _a, _b; return ((_b = (_a = setts === null || setts === void 0 ? void 0 : setts.partials) === null || _a === void 0 ? void 0 : _a.footer) !== null && _b !== void 0 ? _b : ''); });
        ;
