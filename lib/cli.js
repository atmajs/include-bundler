...
(function (ResFlatternUtils) {
    ...
    ResFlatternUtils.distinct = distinct;
    ...
    ResFlatternUtils.toArray = toArray;
    ...
    ResFlatternUtils.takeModuleDescriptions = takeModuleDescriptions;
    ...
    ResFlatternUtils.takePageDefinitions = takePageDefinitions;
...
(function (ResGetTreeInfo) {
    ...
    ResGetTreeInfo.flattern = flattern;
    ;
    function distinct(stack) {
        for (var i = 0; i < stack.length; i++) {
            for (var j = i + 1; j < stack.length; j++) {
...
var CommonJsBuilder = /** @class */ (function (_super) {
    ...
    CommonJsBuilder.prototype.wrapWithCustom = function (body) {
        var opts = this.solution.opts.package;
...
var Bundler = /** @class */ (function (_super) {
    ...
    Bundler.clearCache = function () {
        ...
        if (global_1.io.File.middlewares) {
            for (var key in global_1.io.File.middlewares) {
                var midd = global_1.io.File.middlewares;
                if (midd.clearTemp) {
                    midd.clearTemp();
                }
            }
...
function ensureBundlesConfig(config) {
    if (isMultiConfig(config)) {
        ...
        var bundles = Object.keys(config.apps).map(function (name) {
            var obj = { name: name };
            obj_1.obj_deepExtend(obj, common_1);
