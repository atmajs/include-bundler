...
var ModuleFile = /** @class */ (function () {
    ...
    ModuleFile.prototype.toScript = function (indent) {
        ...
        var indentScopedContent = "" + utils_1.u_makeIndent(scopedContent || '', '    ', io);
        var indentContent = "" + utils_1.u_makeIndent(content, '    ', io);
        content = [
            "" + outerContent || '',
            "" + externalRefs || '',
...
(function (Builder) {
    ...
    function getModuleFromResource(resource) {
        ...
        if (resource.dependencies) {
            ...
            module.imports = resource.dependencies.map(function (dep) {
                var imp = dep["import"];
...
var ImportJsBuilder = /** @class */ (function (_super) {
    ...
    ImportJsBuilder.prototype.buildRoot = function (outputRoot, outputDependencies) {
        ...
        var body = Builder_1.Builder.build(module, {});
