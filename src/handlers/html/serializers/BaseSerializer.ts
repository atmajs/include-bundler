...
import { path_withProtocol } from "../../../utils/path";
import { Resource } from "../../../class/Resource";
import { io } from '../../../global'

export abstract class BaseSerializer {
	constructor (public solution: Solution, public builder: HtmlBuilder) {
	...
	serialize ($, allDependencies): void {
		throw new Error('Not implemented');
	}

	rewrite ($, ownerResource): void {
		throw new Error('Not implemented');
	}
